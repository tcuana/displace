(function($){
    ...
    $(function(){
        ...
        if ($.fn.socialLikes){
            $(document).on('add.cards', function(event){
                $(event.target).outerFind('.social-likes:not(.added)').on('counter.social-likes', function(event, service, counter){
        ...
        var loadGoogleMap = function(){
            ...
            $this.find('.google-map__marker').each(function(){
            ...
            }).end().html('').addClass('google-map--loaded');
            if (markers.length){
        ...
        $(document).on('add.cards', function(event){
            if (window.google && google.maps){
                $(event.target).outerFind('.google-map').each(function(){
            ...
            $(event.target).outerFind('[data-bg-video]').each(function(){
                ...
                for (var i = 0; i < patterns.length; i++){
                    if (result = patterns[i].exec(videoURL)){
                        ...
                        var $img = $('<div class="background-video-preview">')
                            .hide()
                            .css({
                        ...
                        if ($.fn.YTPlayer && !$.isMobile()){
                            ...
                            $('.container:eq(0)', this).before('<div class="background-video"></div>').prev()
                                .YTPlayer($.extend({
                                    videoURL : result[1],
                                    containment : 'self',
                                    showControls : false,
